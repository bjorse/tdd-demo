...
{
    public class NärEnÄrBorttagen : GivetEnChangedOrderItemsInformationLoader
    {
        private const string ExpectedChangedText = "The Testy test (#72) should no longer be packaged";
