...
{
    public class NärQuantityHarÄndrats : GivetEnChangedOrderItemsLoader
    {
        ...
        protected override void Given()
        {
            ...
            _previousModel = new OrderShipmentModel
            {
                ...
                {
                    new OrderItemShipmentModel {OrderItem = {Quantity = 2, Item = {Id = 1}}}
                }
            };
        ...
        {
            Assert.AreEqual(2, _result.First().PreviousQuantity);
        }
